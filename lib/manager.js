...
Manager.prototype.saveModel = function(model, properties) {
  return this.set(model, properties).then(function(result) {
    return result.hasChanged() ? result.save() : result;
  }).catch(function(error) {
    console.error(error.stack);
    throw error;
  });
...
Manager.prototype.setModel = function(model, properties) {
  ...
  if (properties && properties.id) {
    ...
    promises.push(function() {
      return model.hasChanged() ? model.save() : model;
    });
  }
